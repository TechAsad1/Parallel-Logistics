...
import { getLoadingTerm } from '../../../redux/Action';
...
function LoadingTerms() {
    ...
    const columns = [
        ...
        {
            title: "Loading Term",
            dataIndex: "loadingTermDesc",
            sorter: (a, b) => a.loadingTermDesc.length - b.loadingTermDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
        ...
        <div>
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Loading Term</h5>
                        <Text type="secondary">Manage your loading term</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New LoadingTerm</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={loadingTermArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
