...
import { getJobType } from '../../../redux/Action';
...
function JobTypes() {
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a, b) => a.jobTypeDesc.length - b.jobTypeDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
        ...
        <div>
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Job Type</h5>
                        <Text type="secondary">Manage your job type</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New JobType</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={jobTypeArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
