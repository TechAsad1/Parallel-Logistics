...
import { getPortOfDischarge } from '../../../redux/Action';
...
function PortOfDischarges() {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "portOfDischargeDesc",
            sorter: (a, b) => a.portOfDischargeDesc.length - b.portOfDischargeDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
            ...
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <Text type="secondary">Manage your port of discharge</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New PortOfDischarge</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={portOfDischargeArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
