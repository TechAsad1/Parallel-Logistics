...
import EditCargoItem from "./EditCargoItem";
// import AddCargoItem from "./AddCargoItem";
...
function CargoItems() {
    ...
    const columns = [
        ...
        {
            title: "Cargo Item",
            dataIndex: "cargoDetailDesc",
            sorter: (a, b) => a.cargoDetailDesc.length - b.cargoDetailDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
        ...
        <div>
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Cargo Items</h5>
                        <Text type="secondary">Manage your cargo items</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New CargoItem</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={cargoDetailArrs} />
                    </div>
                </div>
            </Content>
            <EditCargoItem
