...
import { getGrossWeight } from '../../../redux/Action';
...
function GrossWeights() {
    ...
    const columns = [
        ...
        {
            title: "GrossWeight",
            dataIndex: "grossWeightDesc",
            sorter: (a, b) => a.grossWeightDesc.length - b.grossWeightDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
        ...
        <div>
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Gross Weight</h5>
                        <Text type="secondary">Manage your gross weight</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New GrossWeight</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={grossWeightArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
