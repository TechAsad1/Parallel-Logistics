...
import { getShippingLine } from '../../../redux/Action';
...
function ShippingLines() {
    ...
    const columns = [
        ...
        {
            title: "Shipping Line",
            dataIndex: "shippingLineDesc",
            sorter: (a, b) => a.shippingLineDesc.length - b.shippingLineDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
        ...
        <div>
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Shipping Line</h5>
                        <Text type="secondary">Manage your Shipping Line</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New Shipping Lines</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={shippingLineArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
