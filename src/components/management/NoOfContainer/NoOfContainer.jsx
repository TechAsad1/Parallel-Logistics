...
import { getNoOfContainer } from '../../../redux/Action';
...
function NoOfContainer() {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "noOfContainerDesc",
            sorter: (a, b) => a.noOfContainerDesc.length - b.noOfContainerDesc.length,
        },
        {
            title: "Actions",
            dataIndex: "actions",
            ...
            <Content style={{ margin: '0 16px' }}>
                ...
                <div className="header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <Text type="secondary">Manage your no of container</Text>
                    </div>
                    <Button type="primary" onClick={() => setModalNewOpen(true)}>Add New NoOfContainer</Button>
                </div>
                <div
                    style={{
                        padding: 24,
                ...
                >
                    ...
                    <div className="table-responsive">
                        <Table columns={columns} dataSource={noOfContainerArrs} />
                    </div>
                </div>
            </Content>
            {/* <EditCustomer
